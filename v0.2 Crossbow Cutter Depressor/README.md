...
I’ve created and evaluated several mounting options that bolt to the front‑left 1515 extrusion. This evolved to MK II mid‑body and MK III to further minimise lost build space. Currently using MK III. 

With MK I I lost roughly 7 mm × 25 mm of usable area and masked this in my slicer using `0x0, 0x25, 7x25, 7x0, 0x0`.
...
> [!NOTE]
> X needs to be at least 4.7 mm so the Crossbow arm doesn’t hit the 1515 extrusion during the cut maneuver and causing skipped steps.
