...
Trying to park up and capping the nozzle is the goal and only clearing x/y during print.  Might be best to handle in HH when blobifier == true and print is being resumed  
